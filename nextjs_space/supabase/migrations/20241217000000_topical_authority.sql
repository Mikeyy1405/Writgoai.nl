-- Topical Authority System Database Schema
-- Migration: 20241217000000_topical_authority
-- This migration creates the complete database structure for the Topical Authority system
...
CREATE TABLE IF NOT EXISTS "PillarTopic" (
  "id" TEXT NOT NULL PRIMARY KEY DEFAULT gen_random_uuid()::text,
  "mapId" TEXT NOT NULL,
  "title" TEXT NOT NULL,
  "slug" TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS "PlannedArticle" (
  "id" TEXT NOT NULL PRIMARY KEY DEFAULT gen_random_uuid()::text,
...
CREATE TABLE IF NOT EXISTS "WordPressSitemapCache" (
  "id" TEXT NOT NULL PRIMARY KEY DEFAULT gen_random_uuid()::text,
  "projectId" TEXT NOT NULL,
  "url" TEXT NOT NULL,
  "title" TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS "DataForSEOCache" (
  "id" TEXT NOT NULL PRIMARY KEY DEFAULT gen_random_uuid()::text,
...
CREATE INDEX IF NOT EXISTS "idx_topical_map_project" ON "TopicalAuthorityMap"("projectId");
CREATE INDEX IF NOT EXISTS "idx_topical_map_client" ON "TopicalAuthorityMap"("clientId");
CREATE INDEX IF NOT EXISTS "idx_topical_map_status" ON "TopicalAuthorityMap"("status");

-- PillarTopic indexes
CREATE INDEX IF NOT EXISTS "idx_pillar_map" ON "PillarTopic"("mapId");
CREATE INDEX IF NOT EXISTS "idx_pillar_status" ON "PillarTopic"("status");
CREATE INDEX IF NOT EXISTS "idx_pillar_order" ON "PillarTopic"("mapId", "order");

-- Subtopic indexes
CREATE INDEX IF NOT EXISTS "idx_subtopic_pillar" ON "Subtopic"("pillarId");
CREATE INDEX IF NOT EXISTS "idx_subtopic_status" ON "Subtopic"("status");
CREATE INDEX IF NOT EXISTS "idx_subtopic_order" ON "Subtopic"("pillarId", "order");

-- PlannedArticle indexes
CREATE INDEX IF NOT EXISTS "idx_planned_article_subtopic" ON "PlannedArticle"("subtopicId");
CREATE INDEX IF NOT EXISTS "idx_planned_article_pillar" ON "PlannedArticle"("pillarId");
CREATE INDEX IF NOT EXISTS "idx_planned_article_map" ON "PlannedArticle"("mapId");
CREATE INDEX IF NOT EXISTS "idx_planned_article_status" ON "PlannedArticle"("status");
CREATE INDEX IF NOT EXISTS "idx_planned_article_scheduled" ON "PlannedArticle"("scheduledDate");
CREATE INDEX IF NOT EXISTS "idx_planned_article_content" ON "PlannedArticle"("savedContentId");
CREATE INDEX IF NOT EXISTS "idx_planned_article_order" ON "PlannedArticle"("subtopicId", "order");

-- WordPressSitemapCache indexes
CREATE INDEX IF NOT EXISTS "idx_sitemap_project" ON "WordPressSitemapCache"("projectId");
CREATE INDEX IF NOT EXISTS "idx_sitemap_topics" ON "WordPressSitemapCache" USING GIN ("topics");
CREATE INDEX IF NOT EXISTS "idx_sitemap_keywords" ON "WordPressSitemapCache" USING GIN ("keywords");
CREATE INDEX IF NOT EXISTS "idx_sitemap_last_scanned" ON "WordPressSitemapCache"("lastScanned");

-- DataForSEOCache indexes
CREATE INDEX IF NOT EXISTS "idx_dataforseo_keyword" ON "DataForSEOCache"("keyword");
CREATE INDEX IF NOT EXISTS "idx_dataforseo_expires" ON "DataForSEOCache"("expiresAt");
