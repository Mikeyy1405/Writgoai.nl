...
import { Sparkles, BookOpen, Zap, ChevronLeft } from 'lucide-react';
...
export default function AdvancedBlogPage() {
    ...
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-[#FF9933]/10 via-gray-900 to-gray-900 rounded-2xl p-8 border border-gray-800">
        ...
        <div className="relative">
          <Link 
            href="/dashboard/blog"
            className="inline-flex items-center gap-1 text-sm text-gray-400 hover:text-[#FF9933] transition-colors mb-4"
          >
            <ChevronLeft className="w-4 h-4" />
            Terug naar eenvoudige modus
          </Link>
          <div className="flex items-center gap-3 mb-3">
            <div className="p-2 bg-[#FF9933]/10 rounded-lg">
              <BookOpen className="w-6 h-6 text-[#FF9933]" />
            </div>
            <h1 className="text-3xl font-bold text-white">Blog Content Pipeline - Geavanceerde Modus</h1>
          </div>
