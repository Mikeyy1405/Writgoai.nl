    ...
    <div className="min-h-screen bg-black py-8 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        {showScanResults && scanResults && (
          <Card className="mb-6 border-2 border-green-300 bg-zinc-900">
            <CardHeader>
            ...
            <Card className="border-2 border-zinc-800">
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Textarea
                    id="toneOfVoice"
                    placeholder="Voorbeeld: 'Gebruik je/jij, schrijf zoals een ervaren ondernemer die advies geeft aan starters. Vriendelijk maar direct. Geen marketingpraat of clichés. Gebruik concrete voorbeelden. Spreek je doelgroep aan alsof je ze persoonlijk kent. Vermijd woorden als: revolutionair, gamechanger, ultiem.'"
                    rows={6}
                    value={formData.toneOfVoice}
                    onChange={(e) => handleInputChange('toneOfVoice', e.target.value)}
                    className="font-mono text-sm"
                  />
                  <div className="mt-2 flex items-start gap-2 p-3 bg-zinc-900 border border-orange-200 rounded-lg">
                    <Brain className="h-5 w-5 text-[#FF6B35] mt-0.5 shrink-0" />
                    <div className="text-xs text-gray-200">
                      <p className="font-semibold text-[#0B3C5D] mb-1">💡 Pro Tip:</p>
