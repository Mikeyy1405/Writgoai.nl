...
export default function ClientSidebar() {
  ...
  return (
    <aside className="hidden lg:flex lg:flex-col w-72 bg-gray-900 border-r border-gray-800 min-h-screen sticky top-0">
      {/* Logo */}
      <div className="h-16 flex items-center px-4 border-b border-gray-800 max-h-16">
