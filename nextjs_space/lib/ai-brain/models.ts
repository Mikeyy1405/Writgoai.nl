...
export const CHAT_MODELS: AIModel[] = [
  ...
  },
  {
    ...
    strengths: ['Nieuwste model', 'Verbeterde reasoning', 'Groot context window', 'Multimodaal'],
    weaknesses: ['Duurste OpenAI model', 'Langzamer dan Mini versies'],
    contextWindow: 400000,
    maxOutput: 16000,
    costPer1kInput: 4.0,
    ...
    speed: 'medium',
    quality: 5,
    bestFor: ['blog_long', 'research', 'code_generate', 'orchestrate', 'analyze'],
    languages: ['nl', 'en', 'de', 'fr', 'es', 'it', 'pt', 'zh', 'ja', 'ko'],
    multimodal: true,
    streaming: true,
    reasoning: true,
  ...
  },
  {
    ...
    provider: 'OpenAI',
    category: 'chat',
    description: 'Nieuwste reasoning model, opvolger van o1',
    strengths: ['Geavanceerde reasoning', 'Hoogste intelligentie', 'Complex problem solving', 'Groot context'],
    weaknesses: ['Zeer duur', 'Langzaam', 'Geen streaming'],
    contextWindow: 200000,
    maxOutput: 32000,
    costPer1kInput: 20.0,
    costPer1kOutput: 80.0,
    speed: 'slow',
    quality: 5,
    bestFor: ['research', 'analyze', 'code_debug', 'orchestrate'],
    languages: ['nl', 'en', 'de', 'fr', 'es', 'it', 'pt'],
    multimodal: false,
    streaming: false,
    reasoning: true,
  ...
  },
  {
    ...
    provider: 'OpenAI',
    category: 'chat',
    description: 'Snelle reasoning variant van o3',
    strengths: ['Snelle reasoning', 'Betaalbaar', 'Goede intelligentie', 'Groot context'],
    weaknesses: ['Minder intelligent dan o3', 'Geen streaming'],
    contextWindow: 128000,
    maxOutput: 16000,
    costPer1kInput: 4.0,
    costPer1kOutput: 16.0,
    speed: 'medium',
    quality: 4,
    bestFor: ['code_debug', 'analyze', 'research', 'code_generate'],
    languages: ['nl', 'en', 'de', 'fr', 'es', 'it', 'pt'],
    multimodal: false,
    streaming: false,
    reasoning: true,
  ...
  },
  {
    ...
    strengths: ['Hoogste reasoning', 'Maximale intelligentie', 'Beste voor complexe problemen', 'Groot context'],
    weaknesses: ['Zeer duur', 'Langzaam', 'Geen streaming', 'Beperkte beschikbaarheid'],
    contextWindow: 200000,
    maxOutput: 32000,
    costPer1kInput: 25.0,
    costPer1kOutput: 100.0,
    speed: 'slow',
    quality: 5,
    bestFor: ['research', 'orchestrate', 'analyze', 'code_debug'],
    languages: ['nl', 'en', 'de', 'fr', 'es', 'it', 'pt'],
    multimodal: false,
    streaming: false,
    reasoning: true,
  ...
  },
  {
    ...
    provider: 'Anthropic',
    category: 'chat',
    description: 'Snelste Claude 4.5 variant met verbeterde kwaliteit',
    strengths: ['Zeer snel', 'Betaalbaar', 'Hogere kwaliteit dan 3.5', 'Streaming', 'Multimodaal'],
    weaknesses: ['Minder intelligent dan Sonnet/Opus', 'Kleiner context dan 1M modellen'],
    contextWindow: 200000,
    maxOutput: 4096,
    costPer1kInput: 1.0,
    costPer1kOutput: 5.0,
  ...
  },
  {
    ...
    provider: 'DeepSeek',
    category: 'chat',
    description: 'Nieuwste DeepSeek versie met verbeterde kwaliteit',
    strengths: ['Extreem goedkoop', 'Hoge kwaliteit', 'Perfect voor bulk', 'Groot context', 'Verbeterde reasoning'],
    weaknesses: ['Minder bekend', 'Langzamer'],
    contextWindow: 128000,
    maxOutput: 8192,
    costPer1kInput: 0.07,
    ...
    speed: 'medium',
    quality: 4,
    bestFor: ['blog_short', 'social_post', 'email', 'translation', 'summarize'],
  ...
  // Zhipu AI GLM Models
  {
    ...
    provider: 'Zhipu AI',
    category: 'chat',
    description: 'Chinese AI specialist, goed voor meertalig en Aziatische talen',
    strengths: ['Excellent meertalig', 'Chinees specialist', 'Betaalbaar', 'Groot context'],
    weaknesses: ['Minder bekend in Europa', 'Fokus op Aziatische talen'],
    contextWindow: 128000,
    maxOutput: 8192,
    costPer1kInput: 0.30,
    costPer1kOutput: 1.20,
    speed: 'medium',
    quality: 4,
    bestFor: ['translation', 'blog_short', 'social_post', 'email'],
    languages: ['nl', 'en', 'zh', 'ja', 'ko', 'de', 'fr', 'es'],
    multimodal: false,
    streaming: true,
    reasoning: false,
  ...
  },
  {
    ...
    provider: 'xAI',
    category: 'chat',
    description: 'Snelste Grok met enorm 2M context window',
    strengths: ['Enorm context (2M!)', 'Real-time data', 'Geen censuur', 'Zeer snel', 'Multimodaal'],
    weaknesses: ['Duur', 'Beperkte beschikbaarheid'],
    contextWindow: 2000000,
    maxOutput: 8192,
    costPer1kInput: 5.5,
    costPer1kOutput: 22.0,
    speed: 'fast',
    quality: 5,
    bestFor: ['research', 'blog_long', 'analyze', 'orchestrate'],
    languages: ['nl', 'en', 'de', 'fr', 'es', 'it', 'pt'],
    multimodal: true,
    streaming: true,
    reasoning: false,
  ...
  // Perplexity Models
  {
    ...
    provider: 'Perplexity',
    category: 'chat',
    description: 'Nieuwste research model met real-time internet en bronvermelding',
    strengths: ['Real-time internet', 'Bronvermelding', 'Research specialist', 'Up-to-date info', 'Fact-checking'],
    weaknesses: ['Duur', 'Minder creatief', 'Fokus op feiten'],
    contextWindow: 128000,
    maxOutput: 8192,
    costPer1kInput: 3.0,
    costPer1kOutput: 12.0,
    speed: 'medium',
    quality: 5,
    bestFor: ['research', 'analyze', 'blog_long', 'summarize'],
    languages: ['nl', 'en', 'de', 'fr', 'es', 'it', 'pt'],
    multimodal: false,
    streaming: true,
    reasoning: false,
...
export const IMAGE_MODELS: AIModel[] = [
  ...
  },
  {
    ...
    provider: 'Google',
    category: 'image',
    description: 'Nieuwste Google image generation met fotorealistische kwaliteit',
    strengths: ['Fotorealistisch', 'Hoge kwaliteit', 'Goede tekstbegrip', 'Consistent'],
    weaknesses: ['Duur', 'Langzaam', 'Beperkte beschikbaarheid'],
    contextWindow: 2048,
    maxOutput: 1,
    costPer1kInput: 6.0,
    costPer1kOutput: 12.0,
  ...
  },
  {
    ...
    provider: 'Black Forest Labs',
    category: 'image',
    description: 'Nieuwste FLUX 2 versie met verbeterde fotorealistische details',
    strengths: ['Beste fotorealisme', 'Hoge details', 'Consistent', 'Verbeterde kwaliteit'],
    weaknesses: ['Duur', 'Langzaam'],
    contextWindow: 2048,
    maxOutput: 1,
    costPer1kInput: 6.0,
  ...
  },
  {
    ...
    provider: 'ByteDance',
    category: 'image',
    description: 'ByteDance\'s nieuwste image model met creatieve stijlen',
    strengths: ['Creatief', 'Goede kwaliteit', 'Betaalbaar', 'Snelle generatie'],
    weaknesses: ['Minder fotorealistisch', 'Nieuwer model'],
    contextWindow: 2048,
    maxOutput: 1,
    costPer1kInput: 2.0,
    costPer1kOutput: 4.0,
    speed: 'fast',
    quality: 4,
    bestFor: ['image_artistic', 'image_thumbnail'],
    languages: ['nl', 'en', 'zh'],
    multimodal: false,
    streaming: false,
    reasoning: false,
  ...
  },
  {
    ...
    provider: 'Alibaba',
    category: 'image',
    description: 'Snelle image generation met goede kwaliteit',
    strengths: ['Zeer snel', 'Goedkoop', 'Goede kwaliteit', 'Hoge doorvoer'],
    weaknesses: ['Minder details dan premium modellen', 'Beperktere stijlen'],
    contextWindow: 2048,
    maxOutput: 1,
    costPer1kInput: 1.0,
    costPer1kOutput: 2.0,
    speed: 'fast',
    quality: 4,
    bestFor: ['image_thumbnail', 'image_realistic'],
    languages: ['nl', 'en', 'zh'],
    multimodal: false,
    streaming: false,
    reasoning: false,
...
export const VIDEO_MODELS: AIModel[] = [
  ...
  },
  {
    ...
    provider: 'Google',
    category: 'video',
    description: 'Text-to-Video en Image-to-Video met hoogste kwaliteit',
    strengths: ['Hoogste kwaliteit', 'Text-to-Video', 'Image-to-Video', 'Langere clips', 'Consistent'],
    weaknesses: ['Zeer duur', 'Langzaam', 'Beperkte beschikbaarheid'],
    contextWindow: 2048,
    maxOutput: 1,
    costPer1kInput: 15.0,
  ...
  },
  {
    ...
    provider: 'OpenAI',
    category: 'video',
    description: 'Nieuwste OpenAI video model met verbeterde realisme',
    strengths: ['Fotorealistisch', 'Hoogste kwaliteit', 'Consistent', 'Langere clips', 'Complexe scenes'],
    weaknesses: ['Zeer duur', 'Langzaam', 'Beperkte beschikbaarheid'],
    contextWindow: 2048,
    maxOutput: 1,
    costPer1kInput: 18.0,
    costPer1kOutput: 36.0,
    speed: 'slow',
    quality: 5,
    bestFor: ['video_generate'],
    languages: ['nl', 'en'],
  ...
  {
    id: 'kuaishou/kling-video-v2.5-turbo-pro',
    name: 'Kling V2.5 Turbo Pro',
    provider: 'Kuaishou',
    category: 'video',
    description: 'Premium video generation met snelheid en kwaliteit',
    strengths: ['Goede kwaliteit', 'Sneller dan top modellen', 'Betaalbaar', 'Consistent'],
    weaknesses: ['Minder kwaliteit dan Veo/Sora', 'Kortere clips'],
    contextWindow: 2048,
    maxOutput: 1,
    costPer1kInput: 8.0,
    costPer1kOutput: 16.0,
  ...
  {
    id: 'kling-ai/kling-2.6-pro',
    name: 'Kling 2.6 Pro',
    provider: 'Kling AI',
    category: 'video',
    description: 'Nieuwste Kling versie met verbeterde kwaliteit',
    strengths: ['Goede kwaliteit', 'Betaalbaar', 'Snelle generatie', 'Consistent'],
    weaknesses: ['Minder kwaliteit dan top modellen'],
    contextWindow: 2048,
    maxOutput: 1,
    costPer1kInput: 7.0,
  ...
  },
  {
    ...
    provider: 'PixVerse',
    category: 'video',
    description: 'Creatieve video effecten met artistieke stijlen',
    strengths: ['Creatief', 'Artistieke effecten', 'Betaalbaar', 'Unieke stijlen'],
    weaknesses: ['Minder fotorealistisch', 'Korte clips'],
    contextWindow: 1024,
    maxOutput: 1,
    costPer1kInput: 5.0,
...
export const VOICE_MODELS: AIModel[] = [
  ...
  },
  {
    ...
    provider: 'ElevenLabs',
    category: 'voice',
    description: 'Nieuwste voice synthesis met verbeterde emotie en natuurlijkheid',
    strengths: ['Beste emotie', 'Zeer natuurlijk', 'Beste Nederlands', 'Veel stemmen', 'Hoogste kwaliteit'],
    weaknesses: ['Duur', 'Alpha versie', 'Rate limiting'],
    contextWindow: 5000,
    maxOutput: 1,
    costPer1kInput: 4.0,
    costPer1kOutput: 8.0,
    ...
    quality: 5,
    bestFor: ['voice_nl', 'voice_en'],
    languages: ['nl', 'en', 'de', 'fr', 'es', 'it', 'pt', 'pl', 'ja', 'zh'],
    multimodal: false,
    streaming: true,
    reasoning: false,
    releaseDate: '2025-12-10'
  ...
  {
    id: 'inworld-ai/tts-1-max',
    name: 'Inworld TTS Max',
    provider: 'Inworld AI',
    category: 'voice',
    description: 'High-quality TTS met emotionele nuance',
    strengths: ['Hoge kwaliteit', 'Emotionele nuance', 'Betaalbaar', 'Natuurlijk'],
    weaknesses: ['Minder stemmen dan ElevenLabs', 'Nieuwer model'],
    contextWindow: 4096,
    maxOutput: 1,
    costPer1kInput: 2.0,
    costPer1kOutput: 4.0,
