        ...
        <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-8">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input
                  type="checkbox"
                  className="w-4 h-4 bg-black/50 border-gray-700 rounded text-orange-500 focus:ring-orange-500"
                />
                <span className="ml-2 text-sm text-gray-400">Onthoud mij</span>
              </label>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-gray-900/50 text-gray-400">Of log in met</span>
            </div>
          </div>
