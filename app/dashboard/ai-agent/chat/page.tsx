        ...
        <div className="max-w-4xl mx-auto space-y-4">
          {messages.length === 0 ? (
            <div className="text-center py-12">
              ...
              <h2 className="text-2xl font-bold mb-2 text-white">Welcome to your AI Agent!</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-2xl mx-auto">
                <button
                  ...
                  className="text-left p-4 border border-gray-800 bg-gray-900 rounded-lg hover:border-primary-500 hover:bg-gray-800 transition-all"
                >
                  <div className="font-medium mb-1 text-white">📊 GSC Report</div>
                ...
                <button
                  ...
                  className="text-left p-4 border border-gray-800 bg-gray-900 rounded-lg hover:border-primary-500 hover:bg-gray-800 transition-all"
                >
                  <div className="font-medium mb-1 text-white">💎 Price Monitor</div>
                  <div className="text-sm text-gray-400">
                ...
                <button
                  ...
                  className="text-left p-4 border border-gray-800 bg-gray-900 rounded-lg hover:border-primary-500 hover:bg-gray-800 transition-all"
                >
                  <div className="font-medium mb-1 text-white">🎯 Competitor Monitor</div>
                  <div className="text-sm text-gray-400">
                ...
                <button
                  ...
                  className="text-left p-4 border border-gray-800 bg-gray-900 rounded-lg hover:border-primary-500 hover:bg-gray-800 transition-all"
                >
                  <div className="font-medium mb-1 text-white">📝 WordPress Publish</div>
                  <div className="text-sm text-gray-400">
                ...
                <div
                  className={`max-w-3xl rounded-lg px-4 py-3 ${
                    message.role === 'user'
                      ...
                      : message.role === 'system'
                      ? 'bg-gray-800 text-primary-500 border border-primary-500'
                ...
                >
                  {message.role === 'agent' && (
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <div className="font-medium text-sm text-gray-400">AI Agent</div>
                    </div>
                  )}
                  ...
                  {message.action_required && message.action_type === 'task_proposal' && (
                    <div className="mt-4 pt-4 border-t border-gray-700">
                      <div className="bg-gray-800 rounded-lg p-4 mb-3">
                        <div className="font-medium mb-2 text-white">📋 {message.action_data.title}</div>
                        ...
                        {message.action_data.steps && message.action_data.steps.length > 0 && (
                          <div className="mb-3">
                            <div className="text-sm font-medium mb-1 text-white">Steps:</div>
                      ...
                      <div className="flex gap-2">
                        ...
                        <button
                          disabled={loading}
                          className="flex-1 bg-gray-800 text-white px-4 py-2 rounded-lg hover:bg-gray-700 border border-gray-700 disabled:opacity-50"
                        >
                          ❌ Cancel
                        </button>
                      </div>
        ...
        <form onSubmit={sendMessage} className="max-w-4xl mx-auto">
          <div className="flex gap-2">
            <input
              ...
              disabled={loading}
              className="flex-1 px-4 py-3 bg-black border border-gray-700 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 disabled:opacity-50 disabled:cursor-not-allowed placeholder-gray-500"
            />
            <button
              type="submit"
              disabled={loading || !input.trim()}
              className="px-6 py-3 bg-primary-500 text-white rounded-lg hover:bg-primary-600 disabled:opacity-50 disabled:cursor-not-allowed font-medium"
            >
